...
const getNextWeekDates = () => {
  ...
  const firstDayOfWeek = new Date(today.setDate(today.getDate() - today.getDay() + 8));
  const lastDayOfWeek = new Date(today.setDate(today.getDate() - today.getDay() + 14));
